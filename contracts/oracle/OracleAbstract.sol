...
abstract contract OracleAbstract is IOracle {
    ...
    /// @return The lowest quote amount in out-currency from the base amount in in-currency.
    ...
    /// @return The first return value is the lowest value in out-currency and the second parameter is the highest
